=== Ghost ===
Contributors: JohnONolan, ErisDS, javorszky, yauh
...
= 0.4.4 =
* Added [HTML_To_Markdown](https://github.com/nickcernis/html-to-markdown) library to convert HTML post content to Markdown
